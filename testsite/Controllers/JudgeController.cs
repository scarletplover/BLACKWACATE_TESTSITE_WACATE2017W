...
namespace testsite.Controllers
{
    public class JudgeController : Controller
    {
        ...
        // GET: Judge
        public async Task<IActionResult> Index(string searchname,string searchkana,string searchoffice)
        {
            ...
            {
                acceptContext = acceptContext.Where(b => b.Name.Equals(searchname));
                ViewData["SearchName"] = searchname;
            }
            if (!string.IsNullOrEmpty(searchkana))
            {
                acceptContext = acceptContext.Where(b => b.NameKana.Equals(searchkana));
                ViewData["SearchKana"] = searchkana;
            }
            if (!string.IsNullOrEmpty(searchoffice))
            {
                acceptContext = acceptContext.Where(b => b.Office.Equals(searchoffice));
